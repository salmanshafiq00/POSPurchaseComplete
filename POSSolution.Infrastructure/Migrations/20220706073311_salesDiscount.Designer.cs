...
namespace POSSolution.Infrastructure.Migrations
{
    ...
    [Migration("20220706073311_salesDiscount")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("POSSolution.Core.Common.Models.DiscountAndTax", b =>
                {
                    ...
                    b.ToTable("DiscountAndTax");

                    b.HasDiscriminator<string>("Discriminator").HasValue("DiscountAndTax");
                });
            ...
            modelBuilder.Entity("POSSolution.Core.Models.SalesDiscountTax", b =>
                {
                    b.HasBaseType("POSSolution.Core.Common.Models.DiscountAndTax");

                    b.HasDiscriminator().HasValue("SalesDiscountTax");
                });
